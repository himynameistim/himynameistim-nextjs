...
export function FeaturedRow1({ posts }: {posts: FeaturedRow1Model}) {
  ...
  <div className={[ linkStyles.row, "grid grid-cols-1 sm:grid-cols-2 md:grid-rows-2 md:grid-cols-12 grid-flow-row md:grid-flow-col gap-4"].join(" ")}>
    ...
    <a className={[ linkStyles.mainBlock, "md:col-span-5 md:row-span-2 pt-8 rounded-md flex justify-center items-center grid place-items-end place-content-end bg-cover"].join(" ")} style={{ backgroundImage: "url(" + posts[0].image.url + "&fit=crop&max-w=630&max-h=400)" }}>
    ...
    <a className={[ linkStyles.secondBlock, "md:col-span-4 md:row-span-2 p-8 rounded-md flex justify-center items-center bg-cover"].join(" ")} style={{ backgroundImage: "url(" + posts[1].image.url + "&fit=crop&max-w=500&max-h=400)" }}>
      <div>
    ...
    <a className={[ linkStyles.finalBlocks, "md:col-span-3 md:row-span-1 pt-8 rounded-md flex justify-center items-center grid place-content-end bg-cover"].join(" ")} style={{ backgroundImage: "url(" + posts[2].image.url + "&fit=crop&max-w=372&max-h=192)" }}>
    ...
    <a className={[ linkStyles.finalBlocks, "md:col-span-3 md:row-span-1 pt-8 rounded-md flex justify-center items-center grid place-content-end bg-cover"].join(" ")} style={{ backgroundImage: "url(" + posts[3].image.url + "&fit=crop&max-w=372&max-h=192)" }}>
      <div className="bg-white w-5/6 p-4 mx-auto">
