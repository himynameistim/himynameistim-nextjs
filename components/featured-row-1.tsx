...
export function FeaturedRow1({ posts }: {posts: FeaturedRow1Model}) {
  ...
  <div className={linkStyles.row}>
    ...
    <a className={linkStyles.secondBlock} style={{ backgroundImage: "url(" + posts[1].image.url + "&fit=crop&max-w=500&max-h=400)" }}>
      <div>
    ...
    <a className={linkStyles.finalBlocks} style={{ backgroundImage: "url(" + posts[2].image.url + "&fit=crop&max-w=372&max-h=192)" }}>
      <div>
    ...
    <a className={linkStyles.finalBlocks} style={{ backgroundImage: "url(" + posts[3].image.url + "&fit=crop&max-w=372&max-h=192)" }}>
      <div>
